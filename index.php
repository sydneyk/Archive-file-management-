                ...
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20" style="color: white;">
                        ...
                        if (isset($_SESSION['message'])) {
                          echo "<h5 class='mb-0'>".$_SESSION['message']."</h5>";
                          unset($_SESSION['message']);
                        }
                    ?>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="inc/login_process.php">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button class="btn btn-success float-right" name="admin/Home_page.php" type="submit">Sign In</button>
